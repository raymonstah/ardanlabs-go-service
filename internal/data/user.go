...
func (user) Retrieve(ctx context.Context, claims auth.Claims, db *sqlx.DB, id string) (*User, error) {
...
func (user) List(ctx context.Context, db *sqlx.DB) ([]User, error) {
...
func (user) Authenticate(ctx context.Context, db *sqlx.DB, now time.Time, email, password string) (auth.Claims, error) {
